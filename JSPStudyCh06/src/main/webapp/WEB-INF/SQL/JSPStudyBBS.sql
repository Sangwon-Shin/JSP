...
-- no, title, writer, content, reg_date, read_count, pass, file
DROP TABLE jspbbs;
DROP TABLE reply;
CREATE TABLE jspbbs(
...
------------------------------------------------------
CREATE TABLE gpus(
    name VARCHAR2(26) PRIMARY KEY,
    chip VARCHAR2(8) NOT NULL, 
    bus VARCHAR2(16) NOT NULL, 
    memory_size VARCHAR2(8) NOT NULL, 
    memory_type VARCHAR2(8) NOT NULL, 
    memory_bus VARCHAR2(6) NOT NULL, 
    gpu_clock VARCHAR2(8) NOT NULL, 
    memory_clock VARCHAR2(8) NOT NULL, 
    shaders NUMBER NOT NULL, 
    tmus NUMBER NOT NULL,
